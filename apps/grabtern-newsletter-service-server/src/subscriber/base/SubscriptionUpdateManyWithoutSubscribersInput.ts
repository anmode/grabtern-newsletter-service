...
@InputType()
class SubscriptionUpdateManyWithoutSubscribersInput {
...
export { SubscriptionUpdateManyWithoutSubscribersInput as SubscriptionUpdateManyWithoutSubscribersInput };
